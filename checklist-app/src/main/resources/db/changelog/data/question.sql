...
insert into question(value, answer_structure_id) values ('Списано паливно-мастильних матеріалів у обсягах, що не перевищують нормативні.', 7) on conflict do nothing;
