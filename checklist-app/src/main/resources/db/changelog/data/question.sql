...
insert into question(value, answer_structure_id) values ('Документальне підтвердження дотримання виконавцем робіт (постачальником товарів/послуг) строків виконання договору', 7) on conflict do nothing;
